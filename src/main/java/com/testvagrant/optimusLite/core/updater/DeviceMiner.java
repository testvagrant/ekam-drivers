...
package com.testvagrant.optimusLite.core.updater;
...
import com.testvagrant.optimusLite.commons.exceptions.NoSuchDeviceTypeException;
import com.testvagrant.optimusLite.commons.exceptions.NoSuchPlatformException;
...
public class DeviceMiner {
    ...
    public DeviceMiner(List<DeviceDetails> deviceDetails, JsonObject testFeed) {
        ...
        optimusDesiredCapabilities = testFeed.getAsJsonObject("optimusDesiredCapabilities");
    ...
    private Map<String, Object> toMap(JsonObject appiumServerCapabilities) {
        Iterator<Map.Entry<String, JsonElement>> keysIterator = appiumServerCapabilities.entrySet().iterator();
        Map<String, Object> capabilitiesMap = new HashMap<>();
        while (keysIterator.hasNext()) {
            String key = keysIterator.next().getKey();
